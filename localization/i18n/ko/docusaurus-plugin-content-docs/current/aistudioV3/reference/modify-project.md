...
```http
https://app.deepbrain.io/api/odin/v3/editor/project/modify
```
...
```bash
curl https://app.deepbrain.io/api/odin/v3/editor/project/modify  \
...
axios.post('https://app.deepbrain.io/api/odin/v3/editor/project/modify', 
  {
    "projectId":"65fa6b07dca2e367461a2925",
    "updates": { 
        "title" : "비디오의 첫 번째 제목 클립에 대한 새로운 텍스트",
...
url = "https://app.deepbrain.io/api/odin/v3/editor/project/modify"
body = {
    "projectId":"65fa6b07dca2e367461a2925",
    "updates": { 
        "title" : "비디오의 첫 번째 제목 클립에 대한 새로운 텍스트",
