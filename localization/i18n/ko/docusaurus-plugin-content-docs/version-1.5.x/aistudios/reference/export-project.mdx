...
|scenes[].AIModel.model|Model's unique key value  [Learn more](./model-list.md)|String|true|-|
|scenes[].AIModel.clothes|The unique key value of the outfit  [Learn more](./model-list.md)|String|true|-|
