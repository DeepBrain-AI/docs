...
|--------------------|----------------------------------|
| 네트워크      | 100Mbps 이상                     |
| PC           | CPU i5 **10세대 이상** 또는 그에 준하는 성능<br/>RAM 8GB 이상       |
| Android      | **AP S710 (Android 10) 이상** 또는 그에 준하는 성능<br/>RAM 4GB 이상<br/>(갤럭시 FE 혹은 A 시리즈의 경우 원활하지 않음) |
| iOS          | iPhone XS (iOS 13) 이상                   |
...
아래와 같이 JavaScript (SDK) 파일을 웹페이지에 추가하십시오.
