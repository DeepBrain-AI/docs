...
```bash
curl https://ai-streamer.deepbrain.io/api/v2/sessions/token\
...
axios.post(
  'https://ai-streamer.deepbrain.io/api/v2/sessions/token',
  {
    appId: 'studiov3.user@example.com',
    userKey: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx'
  },
...
url = 'https://ai-streamer.deepbrain.io/api/v2/sessions/token'
headers = {
    'Content-Type': 'application/json'
}
body = {
