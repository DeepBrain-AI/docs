...
|scenes[].AIModel.model|Model's unique key value  [Learn more](https://docs.deepbrain.io/aistudios/reference/model-list)|String|true|-|
|scenes[].AIModel.clothes|The unique key value of the outfit  [Learn more](https://docs.deepbrain.io/aistudios/reference/model-list)|String|true|-|
