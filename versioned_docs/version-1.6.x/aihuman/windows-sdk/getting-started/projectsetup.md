...
You can authenticate the AppId and userKey prepared above with the first and second parameters of the Authenticate function. You can get the results through the callback of the third parameter.
...
- AIHuman.SDK.Core.dll (1.6.X)
- AIHuman.SDK.WPF.dll (1.6.X)
- JWT.dll (10.1.1)
